...
public class enumExample {
    ...
    public static void main(String[] args) {
        ...
        // Print the enum
        System.out.println(shake.MENGO);
        System.out.println(shake.VENILLA);
        System.out.println(shake.BUTTERSCHOTCHE);

        System.out.println();

        // Find INDEX of every enums
        System.out.println("INDEx is: "+shake.BUTTERSCHOTCHE.ordinal());
        System.out.println("INDEx is: "+shake.MENGO.ordinal());
        System.out.println("INDEx is: "+shake.VENILLA.ordinal());
