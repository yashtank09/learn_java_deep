...
public class Math_Class {
    ...
    // Decreamenting value like this.
    int a = Integer.MIN_VALUE;
    a--;
    System.out.println(a);

    // Decreamenting value
    System.out.println("Exact Decrement: "+Math.decrementExact(100));
    System.out.println("Exact Decrement: "+Math.decrementExact(111));
    ...
    // get exponent
    System.out.println("Exponent value is Floating point Rep. : "+Math.getExponent(12.3456));
    System.out.println("Exponent value is Floating point Rep. : "+Math.getExponent(123.3456));
    ...
    /* 
        Strictmath class is also for mathematical calculation 
    */
